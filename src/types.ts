...
export interface CashierShiftRecord {
  ...
  expenseItems?: { id?: string; category?: string; description: string; amount: number; employeeId?: string; employeeName?: string }[]; // Rincian Pengeluaran Kas Keluar per Item & Kasbon Karyawan
